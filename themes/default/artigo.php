    ...
    <article class="col-md-12">
        ...
        <div class="content artigos well">
            ...
            if ($Login->CheckLogin()):
                ?>
                <div class="row">
                    <div class="thumbnail col-md-offset-10 col-md-2">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Painel de edição</h3>
                            </div>
                            <div class="panel-body">
                                <a class="glyphicon glyphicon-pencil" style="font-size: 2em;" href="<?= HOME ?>/admin/painel.php?exe=posts/update&postId=<?= $post_id; ?>" title="Editar"></a>
                                <?php if (!$post_status): ?>
                                    <a class="glyphicon glyphicon-play" style="font-size: 2em;" href="<?= HOME . "/artigo/$post_name" ?>/active" title="Ativar"></a>
                                <?php else: ?>
                                    <a class="glyphicon glyphicon-stop" style="font-size: 2em;" href="<?= HOME . "/artigo/$post_name" ?>/inative" title="Inativar"></a>
                                <?php endif; ?>
                                <a class="glyphicon glyphicon-trash" style="font-size: 2em;" href="<?= HOME . "/artigo/$post_name" ?>/delete" title="Excluir"></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
