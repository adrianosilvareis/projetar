...
class Seo {
    ...
    private function setLib() {
        //LIBS    
        $this->seoLibs .= "<!--LIBS-->\n";
        $this->seoLibs .= "<link rel='stylesheet' href='" . HOME . "/lib/angular/angular-csp.css'/>\n";
        $this->seoLibs .= "<link rel='stylesheet' href='" . HOME . "/lib/bootstrap/dist/css/bootstrap.min.css'/>\n";
        $this->seoLibs .= "<link rel='stylesheet' href='" . HOME . "/lib/bootstrap/dist/css/bootstrap-theme.min.css'/>\n";
        
        $this->seoLibs .= "<script src='" . HOME . "/lib/jquery/dist/jquery.min.js'></script>\n";
        $this->seoLibs .= "<script src='" . HOME . "/lib/angular/angular.min.js'></script>\n";
        $this->seoLibs .= "<script src='" . HOME . "/lib/angular-route/angular-route.min.js'></script>\n";
        $this->seoLibs .= "<script src='" . HOME . "/lib/angular-locale-pt-br/angular-locale_pt-br.js'></script>\n";
        $this->seoLibs .= "<script src='" . HOME . "/lib/bootstrap/dist/js/bootstrap.min.js'></script>\n";
        $this->seoLibs .= "<script src='" . HOME . "/js/default.js'></script>\n";
        
        
        $this->seoLibs .= "<link href='http://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.3.0/css/font-awesome.min.css'
